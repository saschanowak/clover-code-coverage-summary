...
function getMetricRow(name, metrics, bold = false) {
    const percentage = parseInt(((metrics.coveredelements / metrics.elements) * 100).toString(), 10);
    return `<tr>
  <td>${bold ? '<strong>' : ''}${name}
  <td align="center">${bold ? '<strong>' : ''}${parseInt(((metrics.coveredstatements / metrics.statements) * 100).toString(), 10)}%
  <td align="right">${bold ? '<strong>' : ''}${metrics.coveredstatements}/${metrics.statements}
  <td align="center">${bold ? '<strong>' : ''}${parseInt(((metrics.coveredmethods / metrics.methods) * 100).toString(), 10)}%
  <td align="right">${bold ? '<strong>' : ''}${metrics.coveredmethods}/${metrics.methods}
  <td align="center">${bold ? '<strong>' : ''}${parseInt(((metrics.coveredelements / metrics.elements) * 100).toString(), 10)}%
  <td align="right">${bold ? '<strong>' : ''}${metrics.coveredelements}/${metrics.elements}
